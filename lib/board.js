...
export const STAGES = ['briefings', 'ready', 'testing', 'implementing', 'review', 'done', 'blocked'];
...
export const VALID_TRANSITIONS = {
  ...
  review: ['done', 'ready'],  // ready on rejection
  done: [],                    // terminal state
...
export function checkWipLimit(board, stage) {
  const wipStages = ['testing', 'implementing', 'review'];
...
export function updateBoardStats(board) {
  ...
  const inFlightStages = ['testing', 'implementing', 'review'];
