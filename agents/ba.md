...
hooks:
  PreToolUse:
    ...
    - hooks:
        - type: command
          command: "AGENT_NAME=ba node $CLAUDE_PLUGIN_ROOT/scripts/hooks/observe-pre-tool-use.js"
  PostToolUse:
    - hooks:
        - type: command
          command: "AGENT_NAME=ba node $CLAUDE_PLUGIN_ROOT/scripts/hooks/observe-post-tool-use.js"
  Stop:
    - hooks:
        - type: command
          command: "node $CLAUDE_PLUGIN_ROOT/scripts/hooks/enforce-completion-log.js"
        - type: command
          command: "AGENT_NAME=ba node $CLAUDE_PLUGIN_ROOT/scripts/hooks/observe-stop.js"
---
