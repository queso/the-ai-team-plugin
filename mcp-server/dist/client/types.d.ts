...
export interface KanbanApiClient {
     ...
     */
    post<TResponse, TBody = unknown>(path: string, body?: TBody, options?: Partial<RequestOptions<TBody>>): Promise<ApiResponse<TResponse>>;
    /**
     ...
     */
    request<TResponse, TBody = unknown>(options: RequestOptions<TBody>): Promise<ApiResponse<TResponse>>;
}
/**
