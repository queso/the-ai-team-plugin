 ...
 */
export declare const VALID_AGENTS_LOWER: readonly ["murdock", "ba", "lynch", "amy", "hannibal", "face", "sosa", "tawnia"];
export type ValidAgentLower = (typeof VALID_AGENTS_LOWER)[number];
/**
 * Map from lowercase agent names to API-expected format.
 * Re-exported from @ai-team/shared for backward compatibility.
 */
export declare const AGENT_NAME_MAP: Record<"murdock" | "ba" | "lynch" | "amy" | "hannibal" | "face" | "sosa" | "tawnia", string>;
/**
 ...
 */
export declare const AgentNameSchema: z.ZodEffects<z.ZodEffects<z.ZodEffects<z.ZodString, "murdock" | "ba" | "lynch" | "amy" | "hannibal" | "face" | "sosa" | "tawnia", string>, "murdock" | "ba" | "lynch" | "amy" | "hannibal" | "face" | "sosa" | "tawnia", string>, string, string>;
